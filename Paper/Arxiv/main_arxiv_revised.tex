...
\begin{figure*}[t]
 ...
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/cutoff20260101/forecast_Domain_Specific_Questions_en_paper_cutoff20260101.pdf}
 ...
 \label{fig:tier2_domain}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/cutoff20260101/forecast_General_Reasoning_en_paper_cutoff20260101.pdf}
 ...
 \label{fig:tier2_reasoning}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/cutoff20260101/forecast_High_End_Math_Reasoning_en_paper_cutoff20260101.pdf}
 ...
 \label{fig:tier3_math}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/cutoff20260101/forecast_Core_AGI_Progress_en_paper_cutoff20260101.pdf}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/cutoff20260101/forecast_Agentic_Computer_Use_en_paper_cutoff20260101.pdf}
 ...
 \label{fig:security_cyber}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/cutoff20260101/forecast_Autonomous_SWE_en_paper_cutoff20260101.pdf}
 ...
 \label{fig:security_swe}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/cutoff20260101/forecast_Biology_en_paper_cutoff20260101.pdf}
 ...
 \label{fig:security_bio}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/cutoff20260101/forecast_Chemistry_en_paper_cutoff20260101.pdf}
...
\bibliography{Paper/Benchmark_forecasting}
...
\begin{figure}[hbt!]
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Plots/3-Calibration/cutoff20260101/calibration_harvey_joint_skew_en_paper_cutoff20260101.pdf}
        \caption{\tiny Harvey joint (skew)}
    \end{subfigure}
    \hspace{0.5em}
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Plots/3-Calibration/cutoff20260101/calibration_harvey_joint_normal_en_paper_cutoff20260101.pdf}
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Plots/3-Calibration/cutoff20260101/calibration_harvey_independent_skew_en_paper_cutoff20260101.pdf}
        \caption{\tiny Harvey indep.\ (skew)}
    \end{subfigure}
    \hspace{0.5em}
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Plots/3-Calibration/cutoff20260101/calibration_harvey_independent_normal_en_paper_cutoff20260101.pdf}
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Plots/3-Calibration/cutoff20260101/calibration_logistic_joint_skew_en_paper_cutoff20260101.pdf}
        \caption{\tiny Logistic joint (skew)}
    \end{subfigure}
    \hspace{0.5em}
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Plots/3-Calibration/cutoff20260101/calibration_logistic_joint_normal_en_paper_cutoff20260101.pdf}
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Plots/3-Calibration/cutoff20260101/calibration_logistic_independent_skew_en_paper_cutoff20260101.pdf}
        \caption{\tiny Logistic indep.\ (skew)}
    \end{subfigure}
    \hspace{0.5em}
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Plots/3-Calibration/cutoff20260101/calibration_logistic_independent_normal_en_paper_cutoff20260101.pdf}
...
\begin{figure}[ht!]
 ...
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/cutoff20260101/forecast_Commonsense_QA_en_paper_cutoff20260101.pdf}
 \caption{Commonsense reasoning}
    \end{subfigure}
    \vfill
    \begin{subfigure}[t]{\columnwidth}
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/cutoff20260101/forecast_Advanced_Language_and_Writing_en_paper_cutoff20260101.pdf}
 \caption{Language understanding}
    \end{subfigure}
    \vfill
    \begin{subfigure}[t]{\columnwidth}
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/cutoff20260101/forecast_Multimodal_Understanding_en_paper_cutoff20260101.pdf}
