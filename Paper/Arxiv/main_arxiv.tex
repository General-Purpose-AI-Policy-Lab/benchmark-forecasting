...
\title{Position: The Window for Preventive Action Before Superhuman AI on Most Cognitive Tasks is Closing Rapidly}
...
\begin{figure*}[t]
 ...
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/forecast_Domain_Specific_Questions_en_paper.pdf}
 ...
 \label{fig:tier2_domain}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/forecast_General_Reasoning_en_paper.pdf}
 ...
 \label{fig:tier2_reasoning}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/forecast_High_End_Math_Reasoning_en_paper.pdf}
 ...
 \label{fig:tier3_math}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/forecast_Core_AGI_Progress_en_paper.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{Plots/1-High_level/asymmetry_en_paper.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\columnwidth]{Plots/1-High_level/saturation_en_paper.pdf}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/forecast_Agentic_Computer_Use_en_paper.pdf}
 ...
 \label{fig:security_cyber}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/forecast_Autonomous_SWE_en_paper.pdf}
 ...
 \label{fig:security_swe}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/forecast_Biology_en_paper.pdf}
 ...
 \label{fig:security_bio}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/forecast_Chemistry_en_paper.pdf}
...
\begin{figure}[hbt!]
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Plots/3-Calibration/harvey_joint_en_paper.pdf}
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Plots/3-Calibration/harvey_independent_en_paper.pdf}
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Plots/3-Calibration/logistic_joint_en_paper.pdf}
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Plots/3-Calibration/logistic_independent_en_paper.pdf}
...
\begin{figure}[ht!]
 ...
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/forecast_Commonsense_QA_en_paper.pdf}
 \caption{Commonsense reasoning}
    \end{subfigure}
    \vfill
    \begin{subfigure}[t]{\columnwidth}
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/forecast_Advanced_Language_and_Writing_en_paper.pdf}
 \caption{Language understanding}
    \end{subfigure}
    \vfill
    \begin{subfigure}[t]{\columnwidth}
 \centering
 \includegraphics[width=\textwidth]{Plots/2-Forecasts/forecast_Multimodal_Understanding_en_paper.pdf}
